    ...
    <div className='cart_section'>
        ...
        <div className='cart_container'>
            ...
            <div className='discount_box'>
                ...
                <h4>Free Delhivery<span style={{color:"#111",fontweight:600}}>Oct 8 - 21</span>Details</h4>
                <p>Fastest Delhivery: <span style={{color:"#111",fontweight:600}}>Tommarow 11AM</span></p>
            </div>
